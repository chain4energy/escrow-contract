...
#[test]
fn test_withdraw_operator_success() {
    let app = App::default();
    ...
    assert_eq!(res.events[2].attributes[0].value, controller_addr.to_string(),);
...
#[test]
fn test_withdraw_operator_success_many_denoms() {
    let app = App::default();
    let escrow_code_id = CodeId::store_code(&app);
    let did_code_id = DidContractCodeId::store_code(&app);
    ...
    assert_eq!(res.events[1].attributes[1].value, "escrow1");
    assert_eq!(res.events[1].attributes[2].key, "amount");
    assert_eq!(res.events[1].attributes[2].value, "100uc4e,100zc4e");
...
#[test]
fn test_withdraw_operator_success_already_withdrawn() {
    let app = App::default();
    let escrow_code_id = CodeId::store_code(&app);
    let did_code_id = DidContractCodeId::store_code(&app);
...
#[test]
fn test_withdraw_operator_success_all_used() {
    let app = App::default();
    let escrow_code_id = CodeId::store_code(&app);
    let did_code_id = DidContractCodeId::store_code(&app);
...
#[test]
fn test_withdraw_operator_success_all_fee() {
    let app = App::default();
    let escrow_code_id = CodeId::store_code(&app);
    let did_code_id = DidContractCodeId::store_code(&app);
