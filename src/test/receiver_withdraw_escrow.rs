...
#[test]
fn test_withdraw_receiver_success() {
    let app = App::default();
...
#[test]
fn test_withdraw_receiver_success_many_denoms() {
    let app = App::default();
    let escrow_code_id = CodeId::store_code(&app);
    let did_code_id = DidContractCodeId::store_code(&app);
    ...
    assert_eq!(res.events[1].attributes[1].value, "escrow1");
    assert_eq!(res.events[1].attributes[2].key, "amount");
    assert_eq!(res.events[1].attributes[2].value, "400uc4e,400zc4e");

    assert_eq!(res.events[2].ty, "transfer");
    assert_eq!(res.events[2].attributes.len(), 3);
    assert_eq!(res.events[2].attributes[0].key, "recipient");
    assert_eq!(res.events[2].attributes[0].value, receiver_addr.to_string(),);
    assert_eq!(res.events[2].attributes[1].key, "sender");
    assert_eq!(
        res.events[2].attributes[1].value,
        escrow_contract.contract_addr.to_string()
...
#[test]
fn test_withdraw_receiver_success_already_withdrawn() {
    let app = App::default();
    let escrow_code_id = CodeId::store_code(&app);
    let did_code_id = DidContractCodeId::store_code(&app);
...
#[test]
fn test_withdraw_receiver_success_all_used() {
    let app = App::default();
    let escrow_code_id = CodeId::store_code(&app);
    let did_code_id = DidContractCodeId::store_code(&app);
    ...
    assert_eq!(res.events[1].attributes[1].value, "escrow1");
    assert_eq!(res.events[1].attributes[2].key, "amount");
    assert_eq!(res.events[1].attributes[2].value, "900uc4e");
    ...
    assert_eq!(res.events[2].attributes[2].key, "amount");
    assert_eq!(res.events[2].attributes[2].value, "900uc4e".to_string());
...
#[test]
fn test_withdraw_receiver_success_none_used() {
    let app = App::default();
    let escrow_code_id = CodeId::store_code(&app);
    let did_code_id = DidContractCodeId::store_code(&app);
